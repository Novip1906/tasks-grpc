...
- **Kafka** — брокер событий для передачи сообщений между сервисами 
- **Elasticsearch** - полнотекстовый поиск и фильтрация задач
- **Redis** — хранение временных данных (ограничитель запросов, коды для верификации почты) 
...
- Ограничитель запросов в API-Gateway, использующий алгоритм ***Token Bucket (GCRA)*** на базе Redis
